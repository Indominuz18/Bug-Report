...
bool Customer::findCustomerRecord(std::string customerName, Customer& customerObject) {
    seekToBeginningOfFile();
    while (getNext(customerObject)) {
        if (customerObject.getCustomerName() == customerName) {
            return true;
        }
    }
    return false;
